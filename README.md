...
* All unreviewed, obsolete, and unmapped-data files that were obtained upon mapping our data to UniProt are found in "Incomplete_Mappings" folder. The final and reviewed-data files are saved to "Final_Databases" folder.
